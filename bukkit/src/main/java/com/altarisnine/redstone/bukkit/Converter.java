...
import com.altarisnine.redstone.api.event.entity.DamageCause;
...
import com.altarisnine.redstone.bukkit.entity.living.*;
import com.altarisnine.redstone.bukkit.entity.living.ambient.BukkitBat;
import com.altarisnine.redstone.bukkit.entity.living.creature.*;
import com.altarisnine.redstone.bukkit.entity.living.creature.animal.*;
import com.altarisnine.redstone.bukkit.entity.living.creature.golem.BukkitIronGolem;
import com.altarisnine.redstone.bukkit.entity.living.creature.golem.BukkitShulker;
import com.altarisnine.redstone.bukkit.entity.living.creature.golem.BukkitSnowman;
import com.altarisnine.redstone.bukkit.entity.living.creature.monster.*;
import com.altarisnine.redstone.bukkit.entity.living.creature.npc.BukkitVillager;
import com.altarisnine.redstone.bukkit.entity.living.slime.BukkitMagmaCube;
import com.altarisnine.redstone.bukkit.entity.living.water.BukkitSquid;
import com.altarisnine.redstone.bukkit.inventory.BukkitDroppedItem;
...
public final class Converter {
    ...
    public static <E extends Entity> E getEntity(org.bukkit.entity.Entity entity) {
        if (entity instanceof Player) {
            return (E) Redstone.getApi().getPlayer(entity.getUniqueId());
        }

        try {
             Constructor<?> c = entityMap.get(entity.getClass()).getConstructors()[0];
             Redstone.getApi().getLogger().info(c.toGenericString());
...
// TEMP Redstone.getApi().getLogger().info(entity.getClass().getTypeName());
        if (entity instanceof LivingEntity) {
            if (entity instanceof Creature) {
                ...
                return Redstone.getApi().getPlayer(((Player) entity).getUniqueId());
