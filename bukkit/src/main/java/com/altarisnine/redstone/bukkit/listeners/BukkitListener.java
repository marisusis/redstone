package com.altarisnine.redstone.bukkit.listeners;
...
import com.altarisnine.redstone.bukkit.inventory.BukkitInventoryView;
...
public class BukkitListener extends CoreListener implements Listener {
    ...
    public BukkitListener(RedstoneCore instance) {
        super(instance);
    }
