...
import com.altarisnine.redstone.bukkit.command.BukkitConsoleCommandSender;
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        try {
            if (sender instanceof Player)
                command.process(Redstone.getApi().getPlayer(((Player) sender).getUniqueId()), new ArrayList<>(Arrays.asList(args)));
            else
