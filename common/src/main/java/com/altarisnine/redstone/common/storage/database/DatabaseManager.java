package com.altarisnine.redstone.common.storage.database;
...
import com.altarisnine.redstone.api.storage.database.DatabaseException;
...
public final class DatabaseManager implements Database {
    ...
    public DatabaseManager(RedstoneCore instance) {
...
//            MongoCredential credential = MongoCredential.createCredential("redstone", "redstone", "n3tw0rkc0r3".toCharArray());
        ...
        // Get the database
        database = client.getDatabase("redstone");
    ...
    public void write(StorageGroup group) {
        ...
        Redstone.getApi().getLogger().debug(group.toString());
