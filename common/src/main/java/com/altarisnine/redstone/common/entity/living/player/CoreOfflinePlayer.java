package com.altarisnine.redstone.common.entity.living.player;
...
public class CoreOfflinePlayer implements OfflinePlayer {
    ...
    public CoreOfflinePlayer(RedstoneCore instance, GameProfile profile) {
        this.core = instance;
    ...
    public void setField(String key, String value) {
        Redstone.getApi().getDatabase().writeGroupValue("players", profile.getId().toString(), key, value);
    }

    @Override
    public String getField(String key) {
        return Redstone.getApi().getDatabase().readGroupValue("players", profile.getId().toString(), key);
    }
