package com.altarisnine.networkcore.common.event;

import com.altarisnine.networkcore.api.event.EventListener;
import com.altarisnine.networkcore.api.event.*;
import com.altarisnine.networkcore.api.plugin.EventBrokeException;
...
public class CoreEventManager implements EventManager {
    ...
    public CoreEventManager(NetworkCore instance) {
        this.core = instance;
    }
