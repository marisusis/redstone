...
import com.altarisnine.networkcore.api.guard.handler.BuildHandler;
import com.altarisnine.networkcore.api.guard.handler.EntryHandler;
import com.altarisnine.networkcore.api.guard.handler.ExitHandler;
...
public class CoreGuard implements Guard {
    ...
    public CoreGuard(NetworkCore instance) {
        this.core = instance;
