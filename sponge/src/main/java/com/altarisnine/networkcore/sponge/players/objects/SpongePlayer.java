package com.altarisnine.networkcore.sponge.players.objects;
...
public class SpongePlayer extends CorePlayer {
    ...
    public SpongePlayer(NetworkCore core, UUID playerUUID) {
    ...
    @Override
    public void sendMessage(com.altarisnine.networkcore.api.text.Text text) {
    ...
    @Override
    public void setListName(com.altarisnine.networkcore.api.text.Text name) {
        throw new UnsupportedOperationException("Sponge not implemented!");
    }
    ...
    @Override
    public void sendActionBar(com.altarisnine.networkcore.api.text.Text text) {
        throw new UnsupportedOperationException("BungeeCord not allowed");
    ...
    public void teleport(Location location) {
        Core.getApi().getLogger().info("teleport");
    }
